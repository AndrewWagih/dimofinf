...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.users.store') }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.users.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">add new user</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="username_inp" name="username" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="mobile_number_inp" name="mobile_number" placeholder="example"/>
                                <label for="mobile_number_inp">Enter the mobile number</label>
                            </div>
