...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.posts.update',$post->id) }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.posts.index') }}">
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">edit new post</h3>
                </div>
                <!-- end   :: Card header -->
                 ...
                 <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title" value="{{$post->title??''}}" placeholder="example"/>
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" id="description_inp" name="description" style="height: 240px;" >{{$post->description??''}}</textarea>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="contact_phone_number_inp" name="contact_phone_number" value="{{$post->contact_phone_number??''}}" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select" data-control="select2" name="user_id" id="user-sp"  data-placeholder="{{ __("Choose the user") }}">
                                ...
                                @foreach($users as $user)
                                    <option @if($user->id == $post->user_id) selected @endif value="{{ $user->id }}"> {{ $user->username }} </option>
                                @endforeach
                            </select>
