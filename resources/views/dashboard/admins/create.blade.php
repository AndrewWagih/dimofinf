...
@section('content')
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.admins.index') }}" class="text-muted text-hover-primary">Admin</a></h1>
                <!-- end   :: Title -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.admins.store') }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.admins.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">add new admin</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                ...
                                <label for="name_inp">Enter the name</label>
                            </div>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                ...
                                <label for="phone_inp">Enter the phone</label>
                            </div>
